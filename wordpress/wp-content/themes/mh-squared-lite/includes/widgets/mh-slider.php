...
class mh_squared_lite_slider extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mh_squared_lite_slider', esc_html_x('MH Slider [lite]', 'widget name', 'mh-squared-lite'),
			array(
				'classname' => 'mh_squared_lite_slider',
				'description' => esc_html__('Display any of your posts in a responsive content slider.', 'mh-squared-lite')
			)
		);
	}
