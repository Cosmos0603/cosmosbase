=== MH Squared lite - Magazine WordPress Theme ===
...
MH Squared lite WordPress Theme, Copyright 2015-2017 MH Themes
MH Squared lite is distributed under the terms of the GNU GPL

==================================
Description
==================================

MH Squared lite is a free responsive magazine WordPress theme that is just waiting for your contents. This magazine theme gives you the ability to create an awesome-looking online magazine or a dynamic news website using a modern and sleek layout that is fully-customizable using the advanced theme customizer and an array of custom widgets. For more features and options you can upgrade to the premium version of MH Squared.
...
2.) jQuery FlexSlider v2.4.0 | GPLv2 license | Copyright 2012 WooThemes
...
Quantico by MADType: https://www.google.com/fonts/specimen/Quantico
PT Sans by ParaType: https://www.google.com/fonts/specimen/PT+Sans
...
Overview: http://demo.mh-themes.com/squared/credits/
...
* Removed redundant conditional tag in mh_squared_lite_scripts()
